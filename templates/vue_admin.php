...
?>
        <div class="container mt-5 pl-3 pr-3">
            ...
            <ul class="nav nav-tabs" id="adminTab">
                ...
                <li class="nav-item">
                    <a class="nav-link text-secondary <?php if ($activeTab === 'logs') echo 'active'; ?>" id="logs-tab" data-toggle="tab" onclick="alert('todo')"  role="tab" aria-controls="logs" aria-selected="<?php echo $activeTab === 'logs' ? 'true' : 'false'; ?>">Visualisation des logs</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-secondary <?php if ($activeTab === 'files') echo 'active'; ?>" id="files-tab" onclick="alert('todo')" data-toggle="tab" role="tab" aria-controls="files" aria-selected="<?php echo $activeTab === 'files' ? 'true' : 'false'; ?>">Gestion des fichiers</a>
                </li>
