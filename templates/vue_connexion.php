					...
					<div class="card bg-dark text-white" style="border-radius: 1rem;">
						<div class="card-body p-5 text-center">
							...
							<div class="mb-md-5 mt-md-4">
								...
								<p class="text-white-50 mb-5">Entrez vous identifiants de connexion</p>

								<div data-mdb-input-init class="form-outline form-white mb-4">
									<input type="text" id="typeID"  name="id" class="form-control form-control-lg" />
									<label class="form-label" for="typeID">Identifiant</label>
								</div>
